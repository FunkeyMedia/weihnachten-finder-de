...
const pages: Record<string, ContentPage> = {
  ratgeber: { kicker: 'Kaufberatung', title: 'Ein gutes Geschenk beginnt nicht beim Produkt.', intro: 'Es beginnt bei der Person. Dieser kurze Leitfaden hilft dir, Wünsche zu erkennen, ohne direkt nach einer Einkaufsliste zu fragen.', image: '/images/editorial/weihnachtsgeschenke-verpacken-20260918.webp', action: 'Mit dem Finder anwenden', sections: [
